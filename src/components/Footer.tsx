      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              <a href="https://it-it.facebook.com/da.tommy.33" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-card border border-border rounded-lg px-4 py-2 text-sm hover:border-primary transition-colors">
        ...
        <div className="border-t border-border pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">
            © 2026 Da Tommy — P.IVA 05847930483 · Via Forlanini 8 · Firenze
          </p>
          <a href="https://deliveroo.it/it/menu/firenze/novoli-rifredi/paninoteca-da-tommy" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-primary font-accent uppercase tracking-wider text-sm hover:underline">
